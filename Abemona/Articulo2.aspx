...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="display: flex; align-items: center; flex-direction: column;">
        ...
        <div style="padding: 0 60px; font-size: 30px; margin: 60px 0;">
            ...
            <p>
                Otro aspecto clave este año son las piezas personalizadas. Las joyas que permiten incorporar iniciales, nombres o piedras con significado personal
                se están volviendo muy populares. La idea de llevar algo único y exclusivo resalta la individualidad, convirtiendo a las joyas en no solo un accesorio,
